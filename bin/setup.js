...
// ─── Prior Hook Handler (Unified) ────────────────────────────
// Single handler registered for PostToolUse, PostToolUseFailure, and Stop.
// Collects session metadata, evaluates nudge conditions, injects context.

const PRIOR_HANDLER_SCRIPT = `#!/usr/bin/env node
"use strict";
const fs = require("fs");
const path = require("path");
const os = require("os");
